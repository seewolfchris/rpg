    ...
    public function __invoke(Request $request): View
    {
        ...
        $tutorialSteps = [
            ...
            [
                ...
                'description' => 'Abonniere eine Szene, um Updates und ungelesene Beiträge zu sehen.',
            ...
            [
                'title' => 'Ersten IC/OOC-Beitrag schreiben',
                ...
                'cta' => $hasPost ? 'Weiter schreiben' : 'Beitrag schreiben',
            ],
            [
                'title' => 'Erste SL-Probe im Faden',
                'description' => 'SL/Co-SL führt Proben mit Anlass, Ziel-Held und Modifikator direkt im Beitrag aus.',
                'done' => $hasDiceRoll,
                'url' => route('campaigns.index', ['world' => $selectedWorld]),
                'cta' => $hasDiceRoll ? 'Probe im Faden ansehen' : 'SL-Probe verfolgen',
            ],
            [
                'title' => 'Erstes Lesezeichen setzen',
                ...
                'cta' => $bookmarkCount > 0 ? 'Lesezeichen ansehen' : 'Lesezeichen setzen',
            ],
        ];
