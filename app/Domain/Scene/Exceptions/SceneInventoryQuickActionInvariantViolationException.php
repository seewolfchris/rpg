...
namespace App\Domain\Scene\Exceptions;

use App\Domain\Shared\Exceptions\DomainInvariantViolationException;

class SceneInventoryQuickActionInvariantViolationException extends DomainInvariantViolationException
{
    public static function sceneCampaignMismatch(int $sceneCampaignId, int $campaignId): self
    {
        return new self(
            reason: 'scene_campaign_mismatch',
            field: 'inventory_action_character_id',
            message: 'Inventar-Schnellaktion kann nicht verarbeitet werden, weil Szene und Kampagne nicht zusammenpassen.',
            context: [
    ...
    public static function targetCharacterMissing(int $characterId): self
    {
        return new self(
            ...
            field: 'inventory_action_character_id',
            message: 'Der Ziel-Held konnte nicht gefunden werden.',
            context: [
