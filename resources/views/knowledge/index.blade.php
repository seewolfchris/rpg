...
@section('content')
    <section class="mx-auto w-full max-w-6xl space-y-6">
        <header class="rounded-2xl border border-stone-800 bg-black/45 p-6 shadow-xl shadow-black/40 backdrop-blur-sm sm:p-8">
            ...
            <h1 class="mt-2 font-heading text-3xl text-stone-100 sm:text-4xl">Leitfaden fuer Spiel, Welt und Regeln</h1>
            <p class="mt-4 max-w-4xl text-base leading-relaxed text-stone-300 sm:text-lg">
                Hier findest du den strukturierten Einstieg fuer Chroniken der Asche: wie das Play-by-Post funktioniert,
        ...
        <section class="grid gap-4 lg:grid-cols-3">
            ...
            <article class="rounded-xl border border-stone-800 bg-neutral-900/60 p-5">
                ...
                <h2 class="mt-2 font-heading text-xl text-stone-100">Enzyklopaedie</h2>
                <p class="mt-3 text-sm leading-relaxed text-stone-300">
                    Zeitalter, Fraktionen, Regionen und Begriffe der Welt der letzten Schwuere.
                </p>
                <a
        ...
        <section class="rounded-2xl border border-stone-800 bg-black/45 p-6 shadow-xl shadow-black/40 backdrop-blur-sm sm:p-8">
            <h2 class="font-heading text-2xl text-stone-100">Empfohlener Start fuer neue Spieler</h2>
