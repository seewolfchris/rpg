                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#121217;border:1px solid #2a2a30;border-radius:14px;overflow:hidden;">
                        <tr>
                            <td style="padding:24px 28px;background:linear-gradient(180deg,#1a130f 0%,#121217 100%);border-bottom:1px solid #2a2a30;">
                                ...
                                <h1 style="margin:0;font-size:28px;line-height:1.2;color:#f5f5f4;font-family:'Trebuchet MS',sans-serif;">Passwort zuruecksetzen</h1>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:24px 28px;">
                                <p style="margin:0 0 14px 0;font-size:16px;line-height:1.6;color:#d6d3d1;">Hallo {{ $userName }},</p>
                                <p style="margin:0 0 14px 0;font-size:15px;line-height:1.7;color:#d6d3d1;">du hast eine Zuruecksetzung fuer dein Passwort angefordert. Klicke auf den folgenden Button, um ein neues Passwort zu setzen.</p>
                                ...
                                <p style="margin:24px 0;">
                                    ...
                                    >
                                        Passwort jetzt zuruecksetzen
                                    </a>
                                </p>

                                <p style="margin:0 0 14px 0;font-size:14px;line-height:1.7;color:#a8a29e;">Der Link ist {{ $expirationMinutes }} Minuten gueltig.</p>
