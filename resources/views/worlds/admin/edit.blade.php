...
@section('content')
    <section class="ui-page-medium rounded-2xl border border-stone-800 bg-neutral-900/60 p-6">
    ...
    <section class="ui-page-medium mt-6 rounded-2xl border border-stone-800 bg-neutral-900/60 p-6">
