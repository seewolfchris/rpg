...
<section id="{{ $sectionId }}" class="ui-card border-sky-700/50 bg-sky-950/20 p-6 sm:p-8" data-reading-mode-chrome>
    ...
    <form method="POST" action="{{ $formAction }}" class="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div>
            <label for="magic_spell_roll_mode" class="mb-2 block text-xs font-semibold uppercase tracking-[0.12em] text-stone-300">Zaubermodus</label>
            <select id="magic_spell_roll_mode" name="spell_roll_mode" class="w-full px-4 py-2.5 text-sm text-stone-100">
                ...
                <option value="advantage" @selected((string) old('spell_roll_mode') === 'advantage')>advantage</option>
                <option value="disadvantage" @selected((string) old('spell_roll_mode') === 'disadvantage')>disadvantage</option>
            </select>
        ...
        <div>
            <label for="magic_spell_modifier" class="mb-2 block text-xs font-semibold uppercase tracking-[0.12em] text-stone-300">Zaubermodifikator</label>
            <input
        ...
        <div>
            <label for="magic_defense_roll_mode" class="mb-2 block text-xs font-semibold uppercase tracking-[0.12em] text-stone-300">Magieabwehr-Modus</label>
        ...
        <div>
            <label for="magic_defense_modifier" class="mb-2 block text-xs font-semibold uppercase tracking-[0.12em] text-stone-300">Magieabwehr-Modifikator</label>
            <input
