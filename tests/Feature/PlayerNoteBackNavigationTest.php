...
class PlayerNoteBackNavigationTest extends TestCase
{
    use RefreshDatabase;

    public function test_player_note_show_from_scene_uses_scene_back_link(): void
    {
        [$user, $campaign, $scene] = $this->seedCampaignSceneContext();
        $note = PlayerNote::factory()->forScene($scene)->create([
        ...
        $response = $this->actingAs($user)->get(route('campaigns.player-notes.show', [
