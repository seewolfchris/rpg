...
### Scope
- DB-Migrationen fuer Szenen-/Charakter-Erweiterungen
...
3. Flags fuer Phase A sicherstellen:
...
- Upload-Flow fuer Szenen-Header ohne auffaellige Fehler
...
## Stabilitaetsphase nach Phase A (3-5 Tage)

### Fokus
- Posting-Flow Stabilitaet
- OOC-Toggle-Persistenz pro Szene
- Upload-Handling fuer Headerbilder
...
- Keine offenen Upload-/Persistenz-Bugs mit hoher Prioritaet
...
Rollback:
- Einzelnes Feature sofort ueber Flag deaktivieren
- Kein Schema-Rollback noetig fuer reine UI/Logik-Deaktivierung
